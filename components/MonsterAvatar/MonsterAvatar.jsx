...
const CUTE_ANIMALS = [
  ...
  // 56. Đà điểu nâu hồng
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="352" rx="96" ry="64" fill="#8d6e63"/><path fill="#ffab91" d="M256 352v-160c0-17.7 14.3-32 32-32h16v-64l-48 32-48-32v64h16c17.7 0 32 14.3 32 32v160z"/><circle cx="280" cy="160" r="20" fill="#263238"/><ellipse cx="288" cy="200" rx="32" ry="16" fill="#ff8a65"/><path fill="#5d4037" d="M192 384v48l-16 16 32-16v-48zm128 0v48l16 16-32-16v-48z"/></svg>`,
  ...
  // 64. Sói xám
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="320" rx="112" ry="88" fill="#607d8b"/><circle cx="256" cy="224" r="80" fill="#607d8b"/><path fill="#607d8b" d="M176 176l-48-80 56 32v48zm160 0l48-80-56 32v48z"/><path fill="#cfd8dc" d="M256 256v128l-48 16v-96zm0 0v128l48 16v-96z"/><circle cx="216" cy="208" r="20" fill="#ffeb3b"/><circle cx="296" cy="208" r="20" fill="#ffeb3b"/><circle cx="216" cy="208" r="10" fill="#263238"/><circle cx="296" cy="208" r="10" fill="#263238"/><ellipse cx="256" cy="280" rx="16" ry="12" fill="#37474f"/></svg>`,
  
  // 65. Cáo tuyết trắng
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="320" rx="112" ry="88" fill="#eceff1"/><circle cx="256" cy="224" r="80" fill="#eceff1"/><path fill="#eceff1" d="M176 176l-40-72 48 24v48zm160 0l40-72-48 24v48z"/><circle cx="216" cy="216" r="16" fill="#263238"/><circle cx="296" cy="216" r="16" fill="#263238"/><ellipse cx="256" cy="272" rx="20" ry="16" fill="#263238"/><path fill="#cfd8dc" d="M256 288l-32 32v48h64v-48z"/></svg>`,
  ...
  // 94. Ngựa nâu
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="336" rx="96" ry="72" fill="#8d6e63"/><path fill="#8d6e63" d="M256 336v-176c0-17.7 14.3-32 32-32h32v-32l-64 32-64-32v32h32c17.7 0 32 14.3 32 32v176z"/><circle cx="296" cy="160" r="20" fill="#263238"/><ellipse cx="320" cy="192" rx="24" ry="16" fill="#6d4c41"/><path fill="#5d4037" d="M256 96l32-48v32zm0 0l-32-48v32z"/><path fill="#4e342e" d="M192 384l-16 64 32-32zm128 0l16 64-32-32z"/></svg>`,
  
  // 95. Lừa xám
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="336" rx="96" ry="72" fill="#78909c"/><path fill="#78909c" d="M256 336v-160c0-17.7 14.3-32 32-32h16v-48l-48 32-48-32v48h16c17.7 0 32 14.3 32 32v160z"/><circle cx="288" cy="168" r="16" fill="#263238"/><ellipse cx="304" cy="200" rx="24" ry="16" fill="#90a4ae"/><path fill="#546e7a" d="M208 96l-32-64 48 32v32zm96 0l32-64-48 32v32z"/><ellipse cx="256" cy="376" rx="48" ry="24" fill="#b0bec5"/><path fill="#455a64" d="M192 384l-16 64 32-32zm128 0l16 64-32-32z"/></svg>`,
  ...
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="320" rx="128" ry="72" fill="#6d4c41"/><circle cx="256" cy="232" r="80" fill="#6d4c41"/><circle cx="216" cy="216" r="20" fill="#263238"/><circle cx="296" cy="216" r="20" fill="#263238"/><circle cx="224" cy="208" r="6" fill="#fff"/><circle cx="304" cy="208" r="6" fill="#fff"/><ellipse cx="256" cy="288" rx="64" ry="24" fill="#ff9800"/><ellipse cx="256" cy="280" rx="48" ry="16" fill="#ffb74d"/><ellipse cx="320" cy="376" rx="40" ry="24" fill="#5d4037" transform="rotate(-30 320 376)"/></svg>`,
  
  // 100. Lạc đà vàng nâu
  `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><ellipse cx="256" cy="336" rx="112" ry="72" fill="#d4a056"/><path fill="#d4a056" d="M256 336v-192c0-17.7 14.3-32 32-32h16v-16c0-17.7-14.3-32-32-32h-32c-17.7 0-32 14.3-32 32v16h16c17.7 0 32 14.3 32 32v192z"/><circle cx="288" cy="144" r="16" fill="#263238"/><ellipse cx="304" cy="176" rx="24" ry="20" fill="#c49a4b"/><path fill="#a67c00" d="M200 272c0-26.5 21.5-48 48-48v48zm16 0c0-17.7 14.3-32 32-32v32z"/><path fill="#8d6914" d="M184 384l-24 64 40-32zm144 0l24 64-40-32z"/><ellipse cx="256" cy="376" rx="48" ry="24" fill="#e6c47a"/></svg>`
];

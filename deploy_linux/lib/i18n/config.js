...
// Pages that DON'T have EN versions (app pages - same for all locales)
// These paths will NOT get /en/ prefix
 ...
 * - App-only paths (dashboard, learn, etc.): CÓ thêm /en/ để middleware set cookie đúng
 * 
...
export function getLocalizedUrl(path, targetLocale) {
  ...
  // 🔥 Tiếng Anh - LUÔN thêm /en prefix (middleware sẽ rewrite về URL gốc + set cookie)
  // Điều này đảm bảo khi user click link, locale không bị mất
  if (targetLocale === 'en') {
